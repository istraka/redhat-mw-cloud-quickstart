...
This Azure Resource Manager (ARM) template creates all the Azure compute resources to run JBoss EAP 7.3 setup on RHEL 8.0 VM. The following resources are created by this template:

...
echo "JBoss EAP Password: " ${JBOSS_EAP_PASSWORD} | adddate >> jbosseap.install.log
echo "RHEL OS LICENSE TYPE: " ${RHEL_OS_LICENSE_TYPE} | adddate >> jbosseap.install.log
echo "JBoss Red Hat Username: " ${RHSM_USER} | adddate >> jbosseap.install.log
echo "JBoss Red Hat Password: " ${RHSM_PASSWORD} | adddate >> jbosseap.install.log
echo "JBoss Red Hat EAP Pool ID: " ${RHSM_POOL} | adddate >> jbosseap.install.log
echo "JBoss Red Hat RHEL Pool ID: " ${RHEL_POOL} | adddate >> jbosseap.install.log
echo "Private IP Address: " ${IP_ADDR} | adddate >> jbosseap.install.log
...
echo "Storage Access Key: " ${CONTAINER_NAME} | adddate >> jbosseap.install.log

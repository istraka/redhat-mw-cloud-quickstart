...
echo "Red Hat JBoss EAP 7.3 Cluster Intallation Start " | adddate >> jbosseap.install.log
...
echo "Red Hat JBoss EAP 7.3 Cluster Intallation End " | adddate >> jbosseap.install.log
/bin/date +%H:%M:%S  >> jbosseap.install.log
...
echo "Red Hat JBoss EAP 7.3 Cluster Intallation Start " >> /home/$1/install.log
...
echo "Initial JBoss EAP 7.3 setup" >> /home/$1/install.log
...
echo "Subscribing the system to get access to JBoss EAP 7.3 repos" >> /home/$1/install.log
...
subscription-manager repos --enable=jb-eap-7.3-for-rhel-8-x86_64-rpms >> /home/$1/install.log

echo "Installing JBoss EAP 7.3 repos" >> /home/$1/install.log
...
echo "Red Hat JBoss EAP 7.3 Cluster Intallation End " >> /home/$1/install.log
/bin/date +%H:%M:%S  >> /home/$1/install.log

...
echo "Copy the standalone-azure-ha.xml from EAP_HOME/doc/wildfly/examples/configs folder tp EAP_HOME/wildfly/standalone/configuration folder" >> /home/$1/install.log

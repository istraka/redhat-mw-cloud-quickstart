...
echo "$EAP_HOME/bin/standalone.sh -c standalone-full.xml -bmanagement $IP_ADDR &" | adddate >> jbosseap.install.log
$EAP_HOME/bin/standalone.sh -c standalone-full.xml -bmanagement $IP_ADDR & >> jbosseap.install.log 2>&1

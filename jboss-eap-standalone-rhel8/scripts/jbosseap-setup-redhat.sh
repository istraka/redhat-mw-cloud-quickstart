...
echo "mv ./dukes/target/JBoss-EAP_on_Azure_RHEL8.war $EAP_HOME/standalone/deployments/JBoss-EAP_on_Azure_RHEL8.war" | adddate >> jbosseap.install.log
mv ./dukes/target/JBoss-EAP_on_Azure_RHEL8.war $EAP_HOME/standalone/deployments/JBoss-EAP_on_Azure_RHEL8.war | adddate >> jbosseap.install.log 2>&1
echo "cat > $EAP_HOME/standalone/deployments/JBoss-EAP_on_Azure_RHEL8.war.dodeploy" | adddate >> jbosseap.install.log
cat > $EAP_HOME/standalone/deployments/JBoss-EAP_on_Azure_RHEL8.war.dodeploy | adddate >> jbosseap.install.log 2>&1

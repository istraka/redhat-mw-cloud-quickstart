...
echo "ooooo      RED HAT JBoss EAP 7.3 RPM INSTALL      ooooo" >> /home/$1/install.progress.txt
...
echo "Initial JBoss EAP 7.3 setup" >> /home/$1/install.progress.txt
...
echo "Subscribing the system to get access to JBoss EAP 7.3 repos" >> /home/$1/install.progress.txt

# Install JBoss EAP 7.3
subscription-manager repos --enable=jb-eap-7.3-for-rhel-8-x86_64-rpms >> /home/$1/install.out.txt 2>&1

echo "Installing JBoss EAP 7.3 repos" >> /home/$1/install.progress.txt

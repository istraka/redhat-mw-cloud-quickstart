...
echo "git clone https://github.com/SpektraSystems/redhat-mw-cloud-quickstart.git" | adddate >> wildfly.install.log
git clone https://github.com/SpektraSystems/redhat-mw-cloud-quickstart.git >> wildfly.install.log 2>&1

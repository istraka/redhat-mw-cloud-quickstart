...
echo "wget https://github.com/SpektraSystems/redhat-mw-cloud-quickstart/raw/master/wildfly-standalone-centos8/scripts/JBoss-EAP_on_Azure.war" | adddate >> wildfly.install.log
wget https://github.com/SpektraSystems/redhat-mw-cloud-quickstart/raw/master/wildfly-standalone-centos8/scripts/JBoss-EAP_on_Azure.war >> wildfly.install.log 2>&1
